...
print(StatsComparison)
```
This graph is showing the total career stats for assists, points, and rebounds for Jordan and Lebron's careers respectively. Not only does Lebron lead Jordan in every total career stat, but does at a significant rate. Lebron is currently the all time leading scorer accomplishing the feat earlier this year as well as in the top 4 for total all time assists only behind point guards who are known for passing.
